...
function App() {
	...
	return (
		<Router>
			...
			<Switch>
				<Route path="/login">
					<Login setTitle={setTitle} guest={guest} setGuest={setGuest} />
				</Route>
				<Route path="/account">
					<Account guest={guest} setTitle={setTitle} setGuest={setGuest} />
				</Route>
				<Route path="/order/checkout">
					<Checkout setTitle={setTitle} productOrder={productOrder} guest={guest} />
				</Route>
				<Route path="/order">
					<Order setTitle={setTitle} setProductOrder={setProductOrder} />
				</Route>
